...
## [v1.0.6] - 2026-04-08 — GitHub 发布准备

### 变更范围
- **仓库发布整理**：
  - 新增 `README.md`，补充项目简介、运行方式、目录结构和发布说明，便于直接作为 GitHub 仓库首页使用
  - 更新 `.gitignore`，忽略本地 AI / 自动化工具状态目录与文件（`.claude/`、`.playwright-mcp/`、`.roo/`、`.cursorrules`）
  - 更新 `CLAUDE.md`，移除“禁止推送”限制，改为仅在明确要求时允许推送远程仓库
  - 停止跟踪 `.claude/settings.local.json` 这类本地权限配置，避免将个人环境痕迹推上公开仓库
